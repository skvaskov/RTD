...
W = two_lane_road_static('N_obstacles',N_obstacles,'bound_space',0.4,...
                     ...
                     'obstacle_long_spacing',obstacle_long_spacing,'obstacle_lat_spacing',obstacle_lat_spacing,'obstacle_rotation_bounds',obstacle_rotation_bounds) ;
...
P = rover_RRT_planner('rrt_dynamics',@rover_rrt_dynamics,'verbose',verbose_level,'buffer',buffer,...
                                 't_plan',t_plan,'timeout',t_plan,'t_move',t_move,'plot_HLP_flag',plot_HLP_flag','HLP',lane_HLP,...
                                  ...
                                  'max_heading',max_heading,'straight_std_dev_factor',straight_std_dev_factor,'steering_std_dev_factor',steering_std_dev_factor);
