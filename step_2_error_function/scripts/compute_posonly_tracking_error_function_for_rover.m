...
g_v_cos =  fit_bounding_polynomial_from_samples(v_cos_err_col, [T_data_col;psi_data(:)';K_data_col] ,[t;z(3);k],g_degree_x);
g_v_sin =  fit_bounding_polynomial_from_samples(v_sin_err_col, [T_data_col;psi_data(:)';K_data_col] ,[t;z(3);k],g_degree_y);

g_vy_cos = fit_bounding_polynomial_from_samples(vy_cos_err_col,[T_data_col;psi_data(:)';K_data_col] ,[t;z(3);k],g_degree_y);
g_vy_sin = fit_bounding_polynomial_from_samples(vy_sin_err_col,[T_data_col;psi_data(:)';K_data_col] ,[t;z(3);k],g_degree_x);
