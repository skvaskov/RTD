function h = plot_segway_FRS_in_world_frame(FRS,k,pose,varargin)
% plot_segway_FRS_in_world_frame(FRS,k,pose,'property1',value1,'property2',value2,...)
%
% Given an FRS structure output by compute_segway_FRS.m, a choice of k,
% and a segway pose (x,y,h), plot the FRS corresponding to k at that
% pose.
%
