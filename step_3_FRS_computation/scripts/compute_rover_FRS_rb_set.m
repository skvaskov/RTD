...
if i == 1
  ...
  solver_input_problem(i).hFRS_states = [t*(1-t);1-x^2;hK(1:3)];
  ...
  solver_input_problem(i).hFRS_states = [t*(1-t);1-y^2;hK(1:3)];
...
if save_result
    ...
    filename = ['rover_FRS_rb_T',num2str(T,'%0.1f'),'_deg',num2str(degree),'_v0_',...
