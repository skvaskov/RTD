...
%error function file
load('rover_sincos_error_functions_T1.5_v0_0.0_to_1.0_degx3_degy3.mat')
%scaling function file
load('rover_FRS_full_scaling_T1.5_psiend_-0.5_to_0.5_v0_0.0_to_1.0_23-Mar-2020.mat')
...
hZ0 = [-xc_unscaled^2;-yc_unscaled^2;-psi_unscaled^2];
...
int_XK = boxMoments([x;y;k(2);k(1);k(3)], [-1;-1;lower_lim_k2;-1;-1],[1;1;upper_lim_k2;1;1]);
...
if save_result
    ...
    save(filename,'FRS_polynomial*','FRS_lyapunov_function*','T','t_f','t','x','y','z','k',...
        'diff_v','f','g','w','lower_lim_*','upper_lim_*','degree','*max','*min','solver_input_problem','*scale','*offset')
end